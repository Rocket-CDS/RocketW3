...
<div class="pageouter">
	<div class="pageinner">
		<div class="header">
			...
			<div class="segment breadcrumbsearch">
				<div class="w3-content">
					<div class="w3-row">
						<div class="w3-col l8 m8 s12 breadcrumb">
							<div class="w3-container w3-section">
								<dnn:BREADCRUMB ID="dnnBreadcrumb" runat="server" CssClass="breadcrumbLink" HideWithNoBreadCrumb="false" RootLevel="0" separator="&lt;span class='breadcrumbseparator'&gt;&nbsp;&lt;/span&gt;&nbsp;" />
							</div>
						</div>
						<div class="w3-col l4 m4 s12 search">
							<div class="w3-container w3-section">
								<dnn:SEARCH ID="dnnSearch" runat="server" AutoSearchDelayInMilliSecond="200" CssClass="searchbutton" EnableTheming="true" EnableWildSearch="True" MinCharRequired="3" placeholder=".." ShowSite="false" ShowWeb="false" Submit="<i class='material-icons searchicon'>search</i>" />
							</div>
						</div>
					</div>
				</div>
